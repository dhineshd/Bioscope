...
public class TutorialThreeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButton = (ImageButton) findViewById(R.id.next_tutorial_three);
        ...
        skipButton = (Button) findViewById(R.id.skip_tutorial_three);
        ...
        skipButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(invokedFromBeginningOfApp) {
                    ...
                    startActivity(new Intent(TutorialThreeActivity.this, UserLoginActivity.class));
                }
    ...
    private void showNextAndDestroyCurrentActivity() {
        ...
        Intent i = new Intent(TutorialThreeActivity.this, TutorialFourActivity.class);
    ...
    private void showPreviousAndDestroyCurrentActivity() {
        ...
        Intent i = new Intent(TutorialThreeActivity.this, TutorialTwoActivity.class);
        i.putExtra(ChameleonApplication.TUTORIAL_INVOKED_FROM_BEGINNING_OF_APP_KEY, invokedFromBeginningOfApp);
        startActivity(i);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_tutorial_three, menu);
        return true;
    }
